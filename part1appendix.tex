...
\noindent Repository: \url{https://github.com/luckyswaminathan/ese3060finalproject/tree/main}
...
\section{Baseline vs Modified Training Plots (NEXT PAGE)}
...
All experiment logs (baseline and modified runs) are included in our GitHub repository.
Because we can only submit a single PDF, we provide direct links here:


Baseline logs:\\
\url{https://github.com/luckyswaminathan/ese3060finalproject/tree/main/logs_speed_baseline}

Modified version logs:\\
\url{https://github.com/luckyswaminathan/ese3060finalproject/tree/main/logs_speed_changes}


These log files contain the full per-epoch training and evaluation tables,
including runtimes, accuracies, and summary statistics for all trials.

Screenshots of the log directories are shown on page 6.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{logs_speed_baseline.png}
    \caption{GitHub directory containing baseline log files.}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{logs_speed_changes.png}
    \caption{GitHub directory containing modified-run log files.}
\end{figure}
