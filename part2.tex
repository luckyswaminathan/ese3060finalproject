...
\]
where $\mathrm{SiLU}(x) = x \cdot \sigma(x)$ is the Swish activation function. Gated activations provide additional expressivity by allowing the model to learn which features to pass through, while SiLU provides smoother gradients compared to ReLU.
