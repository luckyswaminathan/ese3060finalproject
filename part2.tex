...
versus step or wall-clock time).

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{baseline_curve_part2.png}
    \caption{Baseline ReLU$^2$ MLP: training and validation loss vs.\ step.}
    \label{fig:baseline-curve}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{swiglu_curve_part2.png}
    \caption{SwiGLU--thin MLP: training and validation loss vs.\ step.}
