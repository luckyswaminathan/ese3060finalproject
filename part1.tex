...
\begin{itemize}[leftmargin=*,nosep]
    ...
    We reduced the number of epochs (e.g., from 9.9 to 8.0) to trade a small loss in optimization for faster overall runtime.
...
In future iterations, we would tune the number of epochs and learning rate more finely (or add mild regularization changes) to see if we can recover the lost $\sim$1.3 percentage points while keeping most of the $\sim$5.3\% speed-up.
