...
Over 5 runs, the modified version (``lucky'' variant) ran in an average of 1m 48.074s, which is roughly an 5.3\% reduction in wall-clock time, but its accuracy dropped slightly to around 92.74\% (a loss of about 1.3 percentage points compared to the baseline).
